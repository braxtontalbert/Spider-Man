...
namespace Spider_Man.Bosses.A_Start_Search_Algorithm.Runtime
{
    //[ExecuteInEditMode]
    //[AddComponentMenu("")]
    public class GizmosInstance : MonoBehaviour
    {
        ...
        public static GizmosInstance instance;
        ...
        public void ManualInit()
        {
            ...
            {
                Debug.Log("NUll pipeline");
                Camera.onPostRender += OnRendered;
            }
            else
            {
                Debug.Log("Not NUll pipeline");
        ...
        {
            Debug.Log("OnRenderer Context has fired");
            OnRendered(camera);
        }
        ...
        {
            Debug.Log("OnRendered for camera: " + camera.name);
